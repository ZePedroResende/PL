...
yyreduce:
  ...
  switch (yyn)
    {
        case 3:
#line 26 "dicionario.y"
    {install(entry,argumentos);}
    break;

  case 6:
#line 32 "dicionario.y"
    {argumentos = new_nome(); entry = (yyvsp[(1) - (1)].texto);}
    break;

  case 9:
#line 37 "dicionario.y"
    {add_mean(&argumentos, (yyvsp[(1) - (1)].texto));}
    break;

  case 10:
#line 38 "dicionario.y"
    {add_sin(&argumentos, (yyvsp[(1) - (1)].texto));}
    break;

  case 11:
#line 39 "dicionario.y"
    {add_english(&argumentos, (yyvsp[(1) - (1)].texto));}
    break;
